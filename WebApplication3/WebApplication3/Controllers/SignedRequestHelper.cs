...
namespace WebApplication3.Controllers
{
    public class SignedRequestHelper
    {
            ...
            public SignedRequestHelper(string awsAccessKeyId, string awsSecretKey, string destination)
            {
                ...
                this.secret = System.Text.Encoding.UTF8.GetBytes(awsSecretKey);
            ...
            System.Text.StringBuilder builder = new System.Text.StringBuilder();
                ...
                byte[] toSign = System.Text.Encoding.UTF8.GetBytes(stringToSign);
            ...
            System.Text.StringBuilder qsBuilder = new StringBuilder();
